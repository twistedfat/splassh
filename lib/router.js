...
Router.configure({
  ...
  waitOn: function() { Meteor.subscribe('projects'); Meteor.subscribe('tags'); Meteor.subscribe('follows'); Meteor.subscribe('comments');Meteor.subscribe('datasets');Meteor.subscribe("images"); Meteor.subscribe("files");}
//per all route?
});
