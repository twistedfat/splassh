...
Router.configure({
  ...
  waitOn: function() { Meteor.subscribe('projects'); Meteor.subscribe('tags'); Meteor.subscribe('follows'); Meteor.subscribe('comments');Meteor.subscribe('sites');Meteor.subscribe("images"); Meteor.subscribe("files");Meteor.subscribe('notifications');}
//per all route?
});
