...
Router.configure({
  ...
  waitOn: function() {  Meteor.subscribe('images'); Meteor.subscribe('projects'); Meteor.subscribe('tags'); Meteor.subscribe('follows'); Meteor.subscribe('comments');Meteor.subscribe('datasets'); Meteor.subscribe("images"); Meteor.subscribe("files"); Meteor.subscribe("docs"); Meteor.subscribe("docs2");},
//per all route?
});
